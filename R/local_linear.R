get_h_xll<-function (data, marker_name, event_time_name = "years", time_name = "year", event_name = "status2", x, b) 
  #local linear version
{
  ...
  h_c <- sapply(br_s[1:99], function(t){h_xtll(br_X, br_s, int_X, size_s_grid, alpha, x, t, b,  Yi, n, Y) })
  return(h_c)
}
