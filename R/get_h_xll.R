get_h_xll<-function (data, marker_name,  br_s, event_time_name = "years", time_name = "year", event_name = "status2", x, b) 
{
  ...
  h_c <- sapply(br_s[1:(length.s-1)], function(t){h_xtll(br_X, br_s, int_X, length.s, alpha, x, t, b,  Yi, n, Y) })
  return(h_c)
}
